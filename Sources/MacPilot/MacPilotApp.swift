...
enum AppText {
    private static let chinese: [String: String] = [
        ...
        "scPinAfterSmartCapture": "截图后自动贴图", "scQuickAccessTitle": "截图快捷操作", "scQuickAccessHint": "截图后显示快捷操作，可复制、标注或按需贴图；不会自动贴图。",
        "scShortcutHint": "按下任意功能键、字母/数字键，或带 Command、Option、Control、Shift 的组合键。",
        ...
        "scPinTitle": "MacPilot 贴图", "scCopy": "复制", "scAnnotate": "标注", "scClose": "关闭", "scOCR": "OCR",
    ...
    private static let english: [String: String] = [
            ...
            "scPinAfterSmartCapture": "Pin after smart capture", "scQuickAccessTitle": "Screenshot Actions", "scQuickAccessHint": "After capture, choose to copy, annotate, or pin. Pinning is never automatic.",
            "scShortcutHint": "Press any function, letter, or number key, with or without Command, Option, Control, or Shift.",
            ...
            "scPinTitle": "MacPilot Pin", "scCopy": "Copy", "scAnnotate": "Annotate", "scClose": "Close", "scOCR": "OCR",
