...
enum AppText {
    private static let chinese: [String: String] = [
        ...
        "scImageHosting": "图床上传", "scImageHostingHint": "兼容 PicList/PicGo 本地服务，也支持自定义 multipart HTTP 图床。上传使用磁盘文件，不会长期占用原图内存。", "scImageHostingEnable": "启用图床上传", "scImageHostingAutoUpload": "截图完成后自动上传", "scImageHostingProvider": "上传方式", "scImageHostingPicList": "PicList / PicGo 本地服务", "scImageHostingCustom": "自定义 HTTP（multipart）", "scImageHostingEndpoint": "服务地址", "scImageHostingEndpointPlaceholder": "http://127.0.0.1:36677/upload", "scImageHostingEndpointHint": "PicList 默认地址为 http://127.0.0.1:36677/upload。使用本地服务时只发送截图路径；自定义 HTTP 模式会从磁盘流式上传。", "scImageHostingInvalidEndpoint": "请输入有效的 HTTP 或 HTTPS 服务地址。", "scImageHostingNotConfigured": "图床上传尚未配置。", "scImageHostingFileUnavailable": "找不到要上传的截图文件。", "scImageHostingRequestFailed": "图床请求失败：%@", "scImageHostingServerRejected": "图床服务返回 HTTP %d：%@", "scImageHostingServerRejectedDefaultMessage": "图床服务拒绝了上传。", "scImageHostingInvalidResponse": "图床服务返回了无效响应。", "scImageHostingNoPublicURL": "图床响应中没有公开图片链接。", "scImageHostingField": "文件字段名", "scImageHostingFieldPlaceholder": "files", "scImageHostingFieldHint": "常见值为 files 或 file。", "scImageHostingURLPrefix": "链接前缀（可选）", "scImageHostingURLPrefixPlaceholder": "https://img.example.com/", "scImageHostingURLPrefixHint": "服务器返回相对路径时使用，例如 https://img.example.com/。", "scImageHostingToken": "服务密钥（可选）", "scImageHostingTokenPlaceholder": "输入 PicList/PicGo 服务密钥", "scImageHostingTokenSave": "保存密钥", "scImageHostingTokenClear": "清除密钥", "scImageHostingTokenStored": "密钥已保存到钥匙串", "scImageHostingTokenNotStored": "未设置密钥", "scImageHostingCredentialSaveFailed": "无法将服务密钥保存到钥匙串。", "scImageHostingConfiguredHint": "启用后，截图快捷操作或右键菜单中的“上传到云端”会上传当前截图，并把公开链接复制到剪贴板。", "scImageHostingLastError": "最近一次上传失败：%@", "scImageHostingUploadFailed": "图床上传失败：%@", "scImageHostingOpenPicList": "打开 PicList Releases",
    ...
    private static let english: [String: String] = [
            ...
            "scImageHosting": "Image Hosting", "scImageHostingHint": "Works with the PicList/PicGo local server and custom multipart HTTP hosts. Uploads read from disk and do not retain the original image in memory.", "scImageHostingEnable": "Enable image hosting upload", "scImageHostingAutoUpload": "Upload automatically after each screenshot", "scImageHostingProvider": "Upload method", "scImageHostingPicList": "PicList / PicGo local server", "scImageHostingCustom": "Custom HTTP (multipart)", "scImageHostingEndpoint": "Service endpoint", "scImageHostingEndpointPlaceholder": "http://127.0.0.1:36677/upload", "scImageHostingEndpointHint": "PicList defaults to http://127.0.0.1:36677/upload. The local-server mode sends only the screenshot path; custom HTTP mode streams the file from disk.", "scImageHostingInvalidEndpoint": "Enter a valid HTTP or HTTPS service endpoint.", "scImageHostingNotConfigured": "Image hosting is not configured.", "scImageHostingFileUnavailable": "The screenshot file to upload is unavailable.", "scImageHostingRequestFailed": "Image hosting request failed: %@", "scImageHostingServerRejected": "Image hosting server returned HTTP %d: %@", "scImageHostingServerRejectedDefaultMessage": "The image hosting server rejected the upload.", "scImageHostingInvalidResponse": "The image hosting server returned an invalid response.", "scImageHostingNoPublicURL": "The image hosting response did not contain a public image URL.", "scImageHostingField": "File field name", "scImageHostingFieldPlaceholder": "files", "scImageHostingFieldHint": "Common values are files and file.", "scImageHostingURLPrefix": "Public URL prefix (optional)", "scImageHostingURLPrefixPlaceholder": "https://img.example.com/", "scImageHostingURLPrefixHint": "Use this when the server returns a relative path, such as https://img.example.com/.", "scImageHostingToken": "Service secret (optional)", "scImageHostingTokenPlaceholder": "Enter the PicList/PicGo service secret", "scImageHostingTokenSave": "Save Secret", "scImageHostingTokenClear": "Clear Secret", "scImageHostingTokenStored": "Secret saved in Keychain", "scImageHostingTokenNotStored": "No secret configured", "scImageHostingCredentialSaveFailed": "The service secret could not be saved to Keychain.", "scImageHostingConfiguredHint": "When enabled, Upload to Cloud in screenshot actions or the context menu uploads the current screenshot and copies the public link to the clipboard.", "scImageHostingLastError": "The last upload failed: %@", "scImageHostingUploadFailed": "Image hosting upload failed: %@", "scImageHostingOpenPicList": "Open PicList Releases",
