...
enum AppText {
    private static let chinese: [String: String] = [
        ...
        "softRestartFinalConfirmTitle": "确认软重启 macOS？",
        "softRestartFinalConfirmMessage": "这是最后一次确认：所有正在运行的应用都将被关闭，未保存的数据可能丢失，且无法撤销。",
        "softRestartFinalConfirmAction": "确认软重启",
    ...
    private static let english: [String: String] = [
            ...
            "softRestartFinalConfirmTitle": "Confirm User Space Restart?",
            "softRestartFinalConfirmMessage": "Final confirmation: all running apps will be quit, unsaved data may be lost, and this cannot be undone.",
            "softRestartFinalConfirmAction": "Confirm Restart",
