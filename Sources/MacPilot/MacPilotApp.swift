...
final class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    /// 从下载目录直接运行隔离包会触发 App Translocation（随机只读路径），
    /// 辅助功能、屏幕录制和自动化等隐私授权会反复失效。提示用户把应用
    /// 移到「应用程序」文件夹。
    private func notifyIfTranslocated() {
        guard Bundle.main.bundleURL.path.contains("/AppTranslocation/") else { return }
        let alert = NSAlert()
        alert.messageText = AppText.value("updateTranslocationTitle", language: .system)
        alert.informativeText = AppText.value("updateTranslocationBody", language: .system)
        alert.addButton(withTitle: AppText.value("scOK", language: .system))
...
enum AppText {
    private static let chinese: [String: String] = [
        ...
        "awakeDisplaySleepHint": "系统保持运行，但显示器仍可按系统设置关闭。", "awakeStart": "开始", "awakeStopSession": "停止此 Session", "awakeStopSessionMenuItem": "停止第 %d 个 Session：%@ · 开始时间 %@", "awakeActiveSessions": "活跃 Session",
        ...
        "awakeBatteryProtectionHint": "电量低于此阈值时，所有 Awake Session 都会结束。",
        ...
        "awakePowerAdapter": "已连接电源适配器", "awakeChargingCondition": "正在充电", "awakeBatteryLevelCondition": "电池电量",
        "awakeExternalDisplay": "外接显示器", "awakeDisplayMirroringCondition": "显示器镜像已开启", "awakeMinimumDisplayCount": "至少连接的显示器数量",
        "awakeComparison": "比较方式", "awakeComparisonLessThan": "小于", "awakeComparisonLessThanOrEqual": "小于或等于",
        "awakeComparisonEqual": "等于", "awakeComparisonGreaterThanOrEqual": "大于或等于", "awakeComparisonGreaterThan": "大于",
        ...
        "awakeSessionConfig": "Session 配置", "awakeSessionConfigHint": "这里是第 1 步：设置时长和保持唤醒行为。点击开始 Session 后，在第 2 步选择电量保护、电源适配器和自动开启选项。",
        "awakeSessionProtectionTitle": "第 2 步：Session 保护", "awakeSessionProtectionHint": "选择电量保护、电源适配器和自动开启选项，确认后才会开始 Session。", "awakeSessionProtectionConfirm": "确认并开始 Session",
        ...
        "awakeScreenSaverAccessibilityHint": "阻止屏幕保护程序需要辅助功能权限。",
        "awakeEndSessionBelowBattery": "当电量低于 %d%% 时结束会话", "awakeWarnBeforeBatteryEnd": "在结束会话前提示",
        ...
        "scShortcutModes": "截图快捷入口", "scStartMode": "开始", "scSmartCaptureShortcut": "智能元素截图快捷键", "scAreaCaptureShortcut": "区域框选截图快捷键", "scRepeatAreaShortcut": "重复上次区域快捷键", "scApplicationWindowShortcut": "应用窗口截图快捷键", "scFullscreenCaptureShortcut": "全屏截图快捷键", "scActiveWindowCaptureShortcut": "当前窗口截图快捷键", "scAreaAnnotateShortcut": "区域截图并标注快捷键", "scOCRShortcut": "OCR 截图快捷键", "scScrollingShortcut": "滚动长截图快捷键", "scObjectCutoutShortcut": "抠图截图快捷键", "scPinCaptureShortcut": "剪贴板贴图快捷键", "scPostSelectionPinShortcut": "框选后贴图快捷键",
        "scRepeatArea": "重复上次区域", "scNoLastArea": "还没有可重复的区域截图。",
        "scSmartCaptureAccessibilityRequired": "智能截图需要辅助功能权限。请在设置中明确点击授权后再试。",
        "scPinAfterSmartCapture": "截图后自动贴图", "scSaveAfterCapture": "截图后自动保存到本地", "scSaveAfterCaptureHint": "开启后每次截图都会按保存文件夹、格式与质量写入本地文件，并计入截图历史与磁盘占用；关闭后只保留剪贴板、快捷操作与贴图。", "scCopyAfterCapture": "截图后复制到剪贴板", "scShowQuickAccess": "截图后显示快捷操作", "scQuickAccessTitle": "截图快捷操作", "scQuickAccessHint": "截图后显示快捷操作，可复制、标注或按需贴图；不会自动贴图。", "scCaptureAreaUnavailable": "上次选择的区域已不可用。", "scCaptureCoordinateUnavailable": "无法定位鼠标所在显示器，请重试。", "scCaptureOutsideDisplay": "所选区域不在显示器范围内。", "scCaptureMultiDisplayAllocationFailed": "无法创建跨显示器截图。", "scCaptureMultiDisplayCompositionFailed": "无法合成跨显示器截图。", "scCaptureTimedOut": "屏幕截图等待画面超时。", "scCaptureCancelled": "屏幕截图已取消。", "scCaptureAlreadyFinished": "屏幕截图会话已结束。", "scCaptureInvalidFrame": "屏幕录制服务返回了无效画面。", "scActiveWindowUnavailable": "没有找到当前应用窗口。",
        "scImageHosting": "图床上传", "scImageHostingHint": "仅在点击截图工具栏或贴图右键菜单的上传按钮时提交图片。支持 GitHub/Gitee，图片会先写入临时磁盘并分块上传，不会自动上传。", "scImageHostingEnable": "启用手动上传", "scImageHostingProvider": "代码托管平台", "scImageHostingGitHub": "GitHub", "scImageHostingGitee": "Gitee", "scImageHostingRepository": "仓库", "scImageHostingRepositoryOwnerPlaceholder": "所有者（例如 misswell）", "scImageHostingRepositoryNamePlaceholder": "仓库名称（例如 images）", "scImageHostingRepositoryHint": "填写有写入权限的仓库。仅在点击上传时提交当前图片，不会自动上传。", "scImageHostingBranch": "分支", "scImageHostingBranchPlaceholder": "main", "scImageHostingDirectory": "图片目录", "scImageHostingDirectoryPlaceholder": "screenshots（可留空表示根目录）", "scImageHostingInvalidRepository": "请填写有效的仓库所有者、仓库名称、分支和目录。", "scImageHostingNotConfigured": "图床上传尚未配置。", "scImageHostingMissingCredential": "请先保存当前平台的访问 Token。", "scImageHostingUploadInProgress": "已有图片正在上传，请稍候。", "scImageHostingFileUnavailable": "找不到要上传的截图文件。", "scImageHostingUnsupportedFile": "只能上传图片文件。", "scImageHostingFileWriteFailed": "无法准备要上传的图片文件。", "scImageHostingRequestFailed": "图床请求失败：%@", "scImageHostingServerRejected": "图床服务返回 HTTP %d：%@", "scImageHostingServerRejectedDefaultMessage": "图床服务拒绝了上传。", "scImageHostingInvalidResponse": "图床服务返回了无效响应。", "scImageHostingNoPublicURL": "图床响应中没有公开图片链接。", "scImageHostingToken": "访问 Token（仅存钥匙串）", "scImageHostingTokenPlaceholder": "输入 GitHub/Gitee Token", "scImageHostingTokenSave": "保存 Token", "scImageHostingTokenClear": "清除 Token", "scImageHostingTokenStored": "Token 已保存到钥匙串", "scImageHostingTokenNotStored": "未设置 Token", "scImageHostingCredentialSaveFailed": "无法将访问 Token 保存到钥匙串。", "scImageHostingConfiguredHint": "框选完成后点击截图工具栏的上传按钮，或在贴图上右键选择上传。上传成功后公开图片链接会复制到剪贴板。", "scImageHostingUpload": "上传图片", "scImageHostingUploading": "正在上传图片…", "scImageHostingPreparing": "正在准备图片…", "scImageHostingUploadProgress": "已上传 %d%%", "scImageHostingFinalizing": "正在确认上传结果…", "scImageHostingUploadSuccess": "上传成功", "scImageHostingUploadSuccessMessage": "上传成功，图片链接已复制到剪贴板：%@", "scImageHostingLastError": "最近一次上传失败：%@", "scImageHostingUploadFailed": "图床上传失败", "scImageHostingUploadFailureMessage": "上传失败：%@",
        ...
        "scDone": "完成", "scAnnotationTextTitle": "标注文字", "scAnnotationWatermarkTitle": "添加水印", "scText": "文字", "scAdd": "添加", "scAnnotationWheelHint": "滚轮调整粗细；按住 Option + 滚轮调整透明度", "scAnnotationStyleValue": "粗细 %d · 透明度 %d%%", "scAnnotationLineWidth": "线宽", "scAnnotationOpacity": "透明度", "scAnnotationColor": "颜色", "scAnnotationFill": "填充", "scAnnotationLineStyle": "线型", "scAnnotationLineSolid": "实线", "scAnnotationLineDashed": "虚线", "scAnnotationLineDotted": "点线", "scAnnotationHideOptions": "收起编辑选项",
        "scAnnotationEraser": "橡皮擦", "scToolDragBar": "拖动工具栏", "scToolPickVariant": "选择样式", "scToolOCR": "识别文字", "scToolSave": "保存截图", "scToolMore": "更多操作", "scToolSize": "大小", "scToolClearAll": "全部清除", "scToolRoundedCorners": "圆角截图", "scToolShadow": "阴影或边框", "scToolRefresh": "刷新截图", "scToolReselect": "重新选择", "scAdjustSelection": "调整选区",
        ...
        "pipCaptureFocused": "捕获当前窗口", "pipCloseAll": "关闭全部画中画",
        ...
        "windowSwitcherMergeHint": "把指定应用的多个窗口在窗口切换器中折叠为一个卡片，不改变应用实际窗口。",
        "windowSwitcherAutoMerge": "自动合并窗口",
        ...
        "smoothScrollingReverseSection": "鼠标反向", "smoothScrollingReverseSectionHint": "独立于平滑滚动，关闭平滑滚动不会关闭鼠标反向。",
        "smoothScrollingReverseEnable": "启用鼠标反向",
        ...
        "smoothScrollingAccessibilityRequired": "平滑滚动或鼠标反向需要辅助功能权限来读取并改写其他应用中的滚轮事件。",
        ...
        "smoothScrollingExcludedAppsHint": "这些应用不进行平滑处理，可分别设置是否反转滚动方向。",
    ...
    private static let dockGroupsChinese: [String: String] = [
        ...
        "dockGroupsCleanup": "清理分组数据",
        "dockGroupsCleanupAction": "清理全部数据",
        "dockGroupsCleanupMessage": "只删除 MacPilot 自己生成的 Helper App、分组配置与图标缓存；不会删改任何第三方应用。",
        ...
        "dockGroupsIconStyle": "图标外观",
        "dockGroupsIconStyleSystem": "跟随系统",
        "dockGroupsIconStyleLight": "浅色",
        "dockGroupsIconStyleDark": "深色",
        "dockGroupsIconStyleHint": "Dock 上的 Helper 图标用哪套外观。跟随系统会在你切换深浅色时自动重建图标。",
        "dockGroupsDockIconCacheHint": "macOS 会缓存已经固定在 Dock 上的图标：改完外观或图标后如果 Dock 上还是旧图标，把这个图标从 Dock 移除再拖回来（或重新登录一次）就会更新。",
    ...
    private static let dockGroupsEnglish: [String: String] = [
        ...
        "dockGroupsCleanup": "Clean Up Group Data",
        "dockGroupsCleanupAction": "Remove All Group Data",
        "dockGroupsCleanupMessage": "Removes only the helper apps, group configuration and icon cache that MacPilot created. No third-party app is deleted or modified.",
        ...
        "dockGroupsIconStyle": "Icon Appearance",
        "dockGroupsIconStyleSystem": "Match System",
        "dockGroupsIconStyleLight": "Light",
        "dockGroupsIconStyleDark": "Dark",
        "dockGroupsIconStyleHint": "Which appearance the helper icon in the Dock uses. Match System rebuilds it when you switch between light and dark.",
        "dockGroupsDockIconCacheHint": "macOS caches the icon of an item already pinned to the Dock. If it still shows the old icon after a change, remove it from the Dock and drag the helper back in (or log out and back in).",
    ...
    private static let localPortsChinese: [String: String] = [
        ...
        "localPortsPortCount": "监听端口",
        "localPortsClosableCount": "可关闭",
        "localPortsLANCount": "LAN 可达",
        ...
        "localPortsProtected": "无法关闭的进程（%d）",
        "localPortsSearch": "搜索端口、项目、进程或 PID",
        "localPortsRefresh": "刷新",
        "localPortsOpen": "打开本地端口…",
        "localPortsOverview": "监听总览",
        "localPortsProcessList": "监听进程",
        ...
        "localPortsUser": "用户",
        "localPortsUID": "用户 UID",
        "localPortsExecutable": "可执行文件",
        "localPortsWorkingDirectory": "工作目录",
        "localPortsArguments": "启动参数",
        "localPortsUptime": "运行时间 %@",
        "localPortsUptimeUnderMinute": "不足 1 分钟",
        "localPortsUptimeDays": "%d 天",
        "localPortsUptimeHours": "%d 小时",
        "localPortsUptimeMinutes": "%d 分钟",
        "localPortsUptimeDaysCompact": "%d天",
        "localPortsUptimeHoursCompact": "%d小时",
        "localPortsUptimeMinutesCompact": "%d分钟",
        "localPortsStartTime": "启动时间",
        ...
        "localPortsVerifying": "正在验证…",
        "localPortsClosing": "正在发送停止请求…",
        "localPortsProtectedReason": "关闭状态",
        "localPortsOtherUser": "PID %d 属于其他用户，无法关闭。",
        "localPortsProtectedRoot": "当前进程以 root 运行，不执行关闭操作。",
        "localPortsProtectedPID": "PID %d 是系统或 MacPilot 自身，不能停止。",
    ...
    private static let localPortsEnglish: [String: String] = [
        ...
        "localPortsLAN": "%d LAN",
        "localPortsPortCount": "Listening ports",
        "localPortsClosableCount": "Closable",
        "localPortsLANCount": "Reachable on LAN",
        ...
        "localPortsProtected": "Processes That Can't Be Stopped (%d)",
        "localPortsSearch": "Search ports, projects, processes, or PIDs",
        "localPortsRefresh": "Refresh",
        "localPortsOpen": "Open Local Ports…",
        "localPortsOverview": "Listening Overview",
        "localPortsProcessList": "Listening Processes",
        ...
        "localPortsUptimeUnderMinute": "Under 1 min",
        "localPortsUptimeDays": "%d d",
        "localPortsUptimeHours": "%d h",
        "localPortsUptimeMinutes": "%d min",
        "localPortsUptimeDaysCompact": "%d d",
        "localPortsUptimeHoursCompact": "%d h",
        "localPortsUptimeMinutesCompact": "%d min",
        "localPortsStartTime": "Start time",
        ...
        "localPortsCloseTitle": "Stop %@'s service?",
        ...
        "localPortsVerifying": "Verifying…",
        "localPortsClosing": "Sending stop request…",
        "localPortsProtectedReason": "Close status",
        "localPortsOtherUser": "PID %d belongs to another user, so MacPilot can't signal it.",
        "localPortsProtectedRoot": "MacPilot is running as root, so it will not stop services.",
        "localPortsProtectedPID": "PID %d is the system or MacPilot itself and can't be stopped.",
    ...
    private static let english: [String: String] = [
            ...
            "awakeDisplaySleepHint": "The system stays running while the display may still turn off according to System Settings.", "awakeStart": "Start", "awakeStopSession": "Stop this session", "awakeStopSessionMenuItem": "Stop session %d: %@ · Started %@", "awakeActiveSessions": "Active sessions",
            ...
            "awakeBatteryProtectionHint": "All Awake sessions end when the battery falls below this threshold.",
            ...
            "awakePowerAdapter": "Power adapter connected", "awakeChargingCondition": "Battery is charging", "awakeBatteryLevelCondition": "Battery level",
            "awakeExternalDisplay": "External display", "awakeDisplayMirroringCondition": "Display mirroring is active", "awakeMinimumDisplayCount": "Minimum display count",
            "awakeComparison": "Comparison", "awakeComparisonLessThan": "Less than", "awakeComparisonLessThanOrEqual": "Less than or equal",
            "awakeComparisonEqual": "Equal", "awakeComparisonGreaterThanOrEqual": "Greater than or equal", "awakeComparisonGreaterThan": "Greater than",
            ...
            "awakeSessionConfig": "Session Setup", "awakeSessionConfigHint": "Step 1 sets the duration and awake behavior. After you click Start a session, choose battery protection, power-adapter, and automatic-start options in Step 2.",
            "awakeSessionProtectionTitle": "Step 2: Session Protection", "awakeSessionProtectionHint": "Choose battery protection, power-adapter, and automatic-start options. The session starts only after you confirm.", "awakeSessionProtectionConfirm": "Confirm and Start Session",
            ...
            "awakeScreenSaverAccessibilityHint": "Blocking the screen saver requires Accessibility access.",
            "awakeEndSessionBelowBattery": "End the session below %d%% battery", "awakeWarnBeforeBatteryEnd": "Warn before ending the session",
            ...
            "scPinAfterSmartCapture": "Pin after smart capture", "scSaveAfterCapture": "Save screenshots locally after capture", "scSaveAfterCaptureHint": "When on, every capture is written to the output folder using the selected format and quality, and is counted in history and disk usage. When off, captures stay in the clipboard, Quick Access, and pins only.", "scCopyAfterCapture": "Copy screenshots to the clipboard", "scShowQuickAccess": "Show Quick Access after capture", "scQuickAccessTitle": "Screenshot Actions", "scQuickAccessHint": "After capture, choose to copy, annotate, or pin. Pinning is never automatic.", "scCaptureAreaUnavailable": "The last selected area is no longer available.", "scCaptureCoordinateUnavailable": "The pointer could not be mapped to a display. Try again.", "scCaptureOutsideDisplay": "The selected region is outside the display.", "scCaptureMultiDisplayAllocationFailed": "Unable to allocate a multi-display screenshot.", "scCaptureMultiDisplayCompositionFailed": "Unable to compose the multi-display screenshot.", "scCaptureTimedOut": "The screen capture timed out while waiting for a frame.", "scCaptureCancelled": "The screen capture was cancelled.", "scCaptureAlreadyFinished": "The screen capture session has already finished.", "scCaptureInvalidFrame": "ScreenCaptureKit returned an invalid frame.", "scActiveWindowUnavailable": "No active application window was found.", "scObjectCutoutNoForeground": "No foreground object was detected.", "scObjectCutoutMaskFailed": "The foreground mask could not be rendered.",
            "scImageHosting": "Image Hosting", "scImageHostingHint": "Images are submitted only when you click Upload in the screenshot toolbar or a pin's context menu. Supports GitHub/Gitee; the image is staged on disk and streamed in chunks, with no automatic uploads.", "scImageHostingEnable": "Enable manual uploads", "scImageHostingProvider": "Code host", "scImageHostingGitHub": "GitHub", "scImageHostingGitee": "Gitee", "scImageHostingRepository": "Repository", "scImageHostingRepositoryOwnerPlaceholder": "Owner (for example, misswell)", "scImageHostingRepositoryNamePlaceholder": "Repository name (for example, images)", "scImageHostingRepositoryHint": "Use a repository where the token can write. The current image is submitted only after an explicit upload click.", "scImageHostingBranch": "Branch", "scImageHostingBranchPlaceholder": "main", "scImageHostingDirectory": "Image directory", "scImageHostingDirectoryPlaceholder": "screenshots (leave empty for the root)", "scImageHostingInvalidRepository": "Enter a valid owner, repository, branch, and directory.", "scImageHostingNotConfigured": "Image hosting is not configured.", "scImageHostingMissingCredential": "Save an access token for the selected provider first.", "scImageHostingUploadInProgress": "An image is already uploading. Please wait.", "scImageHostingFileUnavailable": "The screenshot file to upload is unavailable.", "scImageHostingUnsupportedFile": "Only image files can be uploaded.", "scImageHostingFileWriteFailed": "The image file could not be prepared for upload.", "scImageHostingRequestFailed": "Image hosting request failed: %@", "scImageHostingServerRejected": "The image hosting service returned HTTP %d: %@", "scImageHostingServerRejectedDefaultMessage": "The image hosting service rejected the upload.", "scImageHostingInvalidResponse": "The image hosting service returned an invalid response.", "scImageHostingNoPublicURL": "The image hosting response did not contain a public image URL.", "scImageHostingToken": "Access token (stored only in Keychain)", "scImageHostingTokenPlaceholder": "Enter a GitHub/Gitee token", "scImageHostingTokenSave": "Save Token", "scImageHostingTokenClear": "Clear Token", "scImageHostingTokenStored": "Token saved in Keychain", "scImageHostingTokenNotStored": "No token configured", "scImageHostingCredentialSaveFailed": "The access token could not be saved in Keychain.", "scImageHostingConfiguredHint": "After selecting an area, click Upload in the screenshot toolbar, or choose Upload from a pin's context menu. The public image URL is copied to the clipboard after success.", "scImageHostingUpload": "Upload Image", "scImageHostingUploading": "Uploading image…", "scImageHostingPreparing": "Preparing image…", "scImageHostingUploadProgress": "Uploaded %d%%", "scImageHostingFinalizing": "Confirming upload…", "scImageHostingUploadSuccess": "Upload succeeded", "scImageHostingUploadSuccessMessage": "Upload succeeded. The image URL was copied to the clipboard: %@", "scImageHostingLastError": "The last upload failed: %@", "scImageHostingUploadFailed": "Image hosting upload failed", "scImageHostingUploadFailureMessage": "Upload failed: %@",
            ...
            "scDone": "Done", "scAnnotationTextTitle": "Annotation text", "scAnnotationWatermarkTitle": "Add watermark", "scText": "Text", "scAdd": "Add", "scAnnotationWheelHint": "Scroll to change thickness; hold Option while scrolling to change opacity", "scAnnotationStyleValue": "Width %d · Opacity %d%%", "scAnnotationLineWidth": "Line width", "scAnnotationOpacity": "Opacity", "scAnnotationColor": "Color", "scAnnotationFill": "Fill", "scAnnotationLineStyle": "Line style", "scAnnotationLineSolid": "Solid", "scAnnotationLineDashed": "Dashed", "scAnnotationLineDotted": "Dotted", "scAnnotationHideOptions": "Hide editing options",
            "scAnnotationEraser": "Eraser", "scToolDragBar": "Drag toolbar", "scToolPickVariant": "Choose variant", "scToolOCR": "Extract Text", "scToolSave": "Save Screenshot", "scToolMore": "More Actions", "scToolSize": "Size", "scToolClearAll": "Clear All", "scToolRoundedCorners": "Rounded Corners", "scToolShadow": "Shadow or Border", "scToolRefresh": "Refresh Capture", "scToolReselect": "Reselect", "scAdjustSelection": "Adjust Selection",
            ...
            "pipCaptureFocused": "Capture Focused Window", "pipCloseAll": "Close All PiP",
            ...
            "windowSwitcherMergeHint": "Collapse a chosen app's multiple windows into one switcher card without changing the app's actual windows.",
            "windowSwitcherAutoMerge": "Automatically merge windows",
            ...
            "smoothScrollingReverseSection": "Mouse direction reversal", "smoothScrollingReverseSectionHint": "Independent from smooth scrolling; disabling smooth scrolling does not disable reversal.",
            "smoothScrollingReverseEnable": "Enable mouse direction reversal",
            ...
            "smoothScrollingAccessibilityRequired": "Smooth scrolling or mouse reversal needs Accessibility access to read and rewrite wheel events in other apps.",
            ...
            "smoothScrollingExcludedAppsHint": "These applications skip smoothing; each can independently reverse its wheel direction.",
...
final class MacPilotModel: ObservableObject {
    ...
    struct StoredConfiguration: Codable {
        ...
        /// 旧版本允许在详情页关掉功能级开关，历史配置里可能仍是关闭的；这里按首页状态
        /// 校正，避免出现「首页开着、功能却没启动」而用户已无处可改的情况。
        ///
        /// 只改配置、不触碰运行时，所以启动路径不会因此申请蓝牙之类权限；
        /// 运行时仍由 `activateFeatureRuntime` 按校正后的状态启动。
        func aligningHomeControlledSwitches() -> Self {
            var aligned = self
            let home = Set(enabledFeatures.compactMap(MainSection.init(rawValue:)))

            if home.contains(.awake) { aligned.awake.isEnabled = true }
            if home.contains(.ble) { aligned.bleUnlock.isEnabled = true }
            if home.contains(.remoteControl) { aligned.remoteControl.isEnabled = true }
            if home.contains(.inputSources) { aligned.inputSources.isEnabled = true }
            // 截屏与贴图的首页开关对应「启用截图功能」，不是「启用定时截屏」。
            if home.contains(.capture) { aligned.screenCapture.screenshotEnabled = true }
            if home.contains(.screenRecording) { aligned.screenRecording.isEnabled = true }
            if home.contains(.pictureInPicture) { aligned.pictureInPicture.isEnabled = true }
            if home.contains(.windowSwitcher) { aligned.windowSwitcher.isEnabled = true }
            if home.contains(.smoothScrolling) { aligned.smoothScrolling.isEnabled = true }
            if home.contains(.clipboard) { aligned.clipboard.isEnabled = true }
            if home.contains(.dockGroups) { aligned.dockGroups.isEnabled = true }
    ...
    init() {
        ...
        // Persist the H.264 hardware fallback: when the user accepts
        // switching to HEVC in the pre-record alert, remember it for future
        // recordings.
        screenRecording.sessionConfigurationHooks = ScreenRecordingSessionHooks(
    ...
    func handleDeepLink(_ url: URL) {
        ...
        case ["capture", "fullscreen"], ["capture", "full-screen"], ["screenshot", "fullscreen"]:
            guard isFeatureEnabled(.capture), screenCapture.settings.screenshotEnabled else { return }
    ...
    private func evaluateQuitRule(_ rule: QuitRule, app: NSRunningApplication?, now: Date) {
        ...
        if let initialQuitDeadline, initialQuitDeadline <= now {
            quitWithoutAutomationPrompt(app)
            quitRuntimeStates[rule.id] = state
            quitDeadlines[rule.id] = nil
    ...
    private func apply(_ configuration: StoredConfiguration) {
        // 首页开关是唯一的功能开关：先按它校正历史配置里可能关闭的功能级开关。
        let configuration = configuration.aligningHomeControlledSwitches()
        enabledSections = Set(
...
extension MacPilotModel {
    ...
    /// 详情页不再有自己的总开关，这里的内部开关只是运行时的镜像：
    /// 用户从首页打开功能时把它打开，让 `activateFromConfiguration()` 能真正启动。
    private func prepareFeatureForUserEnable(_ section: MainSection) {
        ...
        case .capture:
            // 首页的「截屏与贴图」对应截图功能本身；定时截屏是页内的子开关。
            screenCapture.setScreenshotEnabled(true)
...
struct ContentView: View {
    ...
    private var sectionContent: some View {
        ...
        case .screenRecording:
            ScreenRecordingPageView(recording: model.screenRecording)
        case .pictureInPicture:
...
struct BLEUnlockView: View {
    ...
    /// BLE 解锁的开关在首页；这里只显示当前运行状态与权限提示。
    private var enableSection: some View {
        SettingsCard {
            VStack(alignment: .leading, spacing: 4) {
                Text(model.t("bleUnlock")).font(.headline)
                statusLine
            }
            if !model.hasWindowControlAccess() {
                accessibilityHint
            }
        }
    }
