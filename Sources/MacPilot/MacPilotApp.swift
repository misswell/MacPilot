...
enum AppText {
    private static let chinese: [String: String] = [
        ...
        "scPinAfterSmartCapture": "截图后自动贴图", "scQuickAccessTitle": "截图快捷操作", "scQuickAccessHint": "截图后显示快捷操作，可复制、标注或按需贴图；不会自动贴图。", "scCaptureAreaUnavailable": "上次选择的区域已不可用。", "scCaptureOutsideDisplay": "所选区域不在显示器范围内。", "scCaptureMultiDisplayAllocationFailed": "无法创建跨显示器截图。", "scCaptureMultiDisplayCompositionFailed": "无法合成跨显示器截图。", "scActiveWindowUnavailable": "没有找到当前应用窗口。",
        ...
        "scShortcutRegistrationFailed": "快捷键注册失败，可能已被系统或其他应用占用；已保留原快捷键。",
        "scRecordShortcut": "按下快捷键…", "scResetShortcut": "恢复 F1", "scPin": "贴图",
    ...
    private static let english: [String: String] = [
            ...
            "scPinAfterSmartCapture": "Pin after smart capture", "scQuickAccessTitle": "Screenshot Actions", "scQuickAccessHint": "After capture, choose to copy, annotate, or pin. Pinning is never automatic.", "scCaptureAreaUnavailable": "The last selected area is no longer available.", "scCaptureOutsideDisplay": "The selected region is outside the display.", "scCaptureMultiDisplayAllocationFailed": "Unable to allocate a multi-display screenshot.", "scCaptureMultiDisplayCompositionFailed": "Unable to compose the multi-display screenshot.", "scActiveWindowUnavailable": "No active application window was found.",
            ...
            "scShortcutRegistrationFailed": "The shortcut could not be registered; it may be in use by macOS or another app. The previous shortcut was kept.",
            "scRecordShortcut": "Press a shortcut…", "scResetShortcut": "Restore F1", "scPin": "Pin",
