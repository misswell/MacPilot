...
enum AppText {
    private static let chinese: [String: String] = [
        ...
        "awakeDisplaySleepHint": "系统保持运行，但显示器仍可按系统设置关闭。", "awakeStart": "开始", "awakeStopSession": "停止此 Session", "awakeStopSessionMenuItem": "停止第 %d 个 Session：%@ · 开始时间 %@", "awakeActiveSessions": "活跃 Session", "awakeStopAllManual": "停止手动 Session",
    ...
    private static let english: [String: String] = [
            ...
            "awakeDisplaySleepHint": "The system stays running while the display may still turn off according to System Settings.", "awakeStart": "Start", "awakeStopSession": "Stop this session", "awakeStopSessionMenuItem": "Stop session %d: %@ · Started %@", "awakeActiveSessions": "Active sessions", "awakeStopAllManual": "Stop manual sessions",
