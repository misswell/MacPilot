...
enum AppText {
    private static let chinese: [String: String] = [
        ...
        "scDone": "完成", "scAnnotationTextTitle": "标注文字", "scAnnotationWatermarkTitle": "添加水印", "scText": "文字", "scAdd": "添加", "scAnnotationWheelHint": "滚轮调整粗细；按住 Option + 滚轮调整透明度", "scAnnotationStyleValue": "粗细 %d · 透明度 %d%%", "scAnnotationLineWidth": "线宽", "scAnnotationOpacity": "透明度",
