...
final class BookmarkManager: ObservableObject {
    ...
    func promptForPermission(for url: URL) async -> URL? {
        ...
        panel.message = AppLocalization.localized("Grant MacPilot access to this folder to perform Finder context-menu file operations.")
    ...
    func addDirectory() async -> URL? {
        ...
        let panel = NSOpenPanel()
        panel.message = AppLocalization.localized("Choose a folder for MacPilot to access from Finder context-menu actions.")
        panel.prompt = AppLocalization.localized("Grant Access")
        panel.canChooseFiles = false
        panel.canChooseDirectories = true
        panel.canCreateDirectories = false
