...
public enum AppLocalization {
    ...
    private static let simplifiedChinese: [String: String] = [
        ...
        "Restore Previous Menu Settings": "恢复旧版菜单设置",
        "Previous settings were copied safely. Reopen MacPilot to load them.": "旧设置已安全复制。请重新打开 MacPilot 以加载设置。",
        "Your previous settings are preserved. Migration needs access to the old store. Until restored, menu changes are temporary. Retrying may ask for permission once.": "旧设置已保留，迁移需要访问旧数据库。恢复前的菜单改动仅临时保存。重试时可能需要一次系统授权。",
