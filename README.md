...
- The popover has no title bar, no second Dock icon, and no normal window chrome; it closes on Escape or an outside click and supports arrow-key navigation and Retina.
